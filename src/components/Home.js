...
function Home() {
  return (
    <PageTitle title="Home">
      <div>
        <section className="top-h4">
          <div className="overlay"></div>
          <div className="container">
            <div className="space-140 d-none d-lg-block"></div>
            <div className="space-80"></div>
            <div className="space-5"></div>
            <div className="space-3"></div>
            <div className="row">
              <div className="col-xl-6 col-lg-8">
                <h1>SaaS Software Landing is the Best for Your Business</h1>
                <div className="space-3"></div>
                <ul className="none-style list-s1">
                  <li>
                    ...
                    <span>
                      Invest in outstanding startups, find investments for your
                      business, involve the best in your ideas. professionals
                    </span>
                  </li>
                ...
                <div className="space-5"></div>
                <div className="space-3"></div>
                <a href="#" className="octf-btn octf-btn-main btn-large">
                  Try It Now
                </a>
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-lg-2 col-md-4 col-sm-4 col-6 text-center">
                <div className="ot-icon-box icon-box-h4 p-0">
                  <div className="ot-icon-box__icon">
                    {/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="m197.332031 170.667969h-160c-20.585937 0-37.332031-16.746094-37.332031-37.335938v-96c0-20.585937 16.746094-37.332031 37.332031-37.332031h160c20.589844 0 37.335938 16.746094 37.335938 37.332031v96c0 20.589844-16.746094 37.335938-37.335938 37.335938zm-160-138.667969c-2.941406 0-5.332031 2.390625-5.332031 5.332031v96c0 2.945313 2.390625 5.335938 5.332031 5.335938h160c2.945313 0 5.335938-2.390625 5.335938-5.335938v-96c0-2.941406-2.390625-5.332031-5.335938-5.332031zm0 0"></path><path d="m197.332031 512h-160c-20.585937 0-37.332031-16.746094-37.332031-37.332031v-224c0-20.589844 16.746094-37.335938 37.332031-37.335938h160c20.589844 0 37.335938 16.746094 37.335938 37.335938v224c0 20.585937-16.746094 37.332031-37.335938 37.332031zm-160-266.667969c-2.941406 0-5.332031 2.390625-5.332031 5.335938v224c0 2.941406 2.390625 5.332031 5.332031 5.332031h160c2.945313 0 5.335938-2.390625 5.335938-5.332031v-224c0-2.945313-2.390625-5.335938-5.335938-5.335938zm0 0"></path><path d="m474.667969 512h-160c-20.589844 0-37.335938-16.746094-37.335938-37.332031v-96c0-20.589844 16.746094-37.335938 37.335938-37.335938h160c20.585937 0 37.332031 16.746094 37.332031 37.335938v96c0 20.585937-16.746094 37.332031-37.332031 37.332031zm-160-138.667969c-2.945313 0-5.335938 2.390625-5.335938 5.335938v96c0 2.941406 2.390625 5.332031 5.335938 5.332031h160c2.941406 0 5.332031-2.390625 5.332031-5.332031v-96c0-2.945313-2.390625-5.335938-5.332031-5.335938zm0 0"></path><path d="m474.667969 298.667969h-160c-20.589844 0-37.335938-16.746094-37.335938-37.335938v-224c0-20.585937 16.746094-37.332031 37.335938-37.332031h160c20.585937 0 37.332031 16.746094 37.332031 37.332031v224c0 20.589844-16.746094 37.335938-37.332031 37.335938zm-160-266.667969c-2.945313 0-5.335938 2.390625-5.335938 5.332031v224c0 2.945313 2.390625 5.335938 5.335938 5.335938h160c2.941406 0 5.332031-2.390625 5.332031-5.335938v-224c0-2.941406-2.390625-5.332031-5.332031-5.332031zm0 0"></path></svg> */}
                  </div>
                  <div className="ot-icon-box__content">
                    <h6 className="icon-box-title">Dashboard</h6>
                  </div>
                </div>
              </div>
              <div className="col-lg-2 col-md-4 col-sm-4 col-6 text-center">
                <div className="ot-icon-box icon-box-h4 p-0">
                  ...
                  <div className="ot-icon-box__content">
                    <h6 className="icon-box-title">Profiles</h6>
                  </div>
                </div>
              </div>
              <div className="col-lg-2 col-md-4 col-sm-4 col-6 text-center">
                <div className="ot-icon-box icon-box-h4 p-0">
                  <div className="ot-icon-box__icon">
                    {/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="m133.332031 320h-53.332031c-8.832031 0-16-7.167969-16-16v-53.332031c0-8.832031 7.167969-16 16-16h53.332031c8.832031 0 16 7.167969 16 16v53.332031c0 8.832031-7.167969 16-16 16zm-37.332031-32h21.332031v-21.332031h-21.332031zm0 0"></path><path d="m133.332031 448h-53.332031c-8.832031 0-16-7.167969-16-16v-53.332031c0-8.832031 7.167969-16 16-16h53.332031c8.832031 0 16 7.167969 16 16v53.332031c0 8.832031-7.167969 16-16 16zm-37.332031-32h21.332031v-21.332031h-21.332031zm0 0"></path><path d="m282.667969 320h-53.335938c-8.832031 0-16-7.167969-16-16v-53.332031c0-8.832031 7.167969-16 16-16h53.335938c8.832031 0 16 7.167969 16 16v53.332031c0 8.832031-7.167969 16-16 16zm-37.335938-32h21.335938v-21.332031h-21.335938zm0 0"></path><path d="m282.667969 448h-53.335938c-8.832031 0-16-7.167969-16-16v-53.332031c0-8.832031 7.167969-16 16-16h53.335938c8.832031 0 16 7.167969 16 16v53.332031c0 8.832031-7.167969 16-16 16zm-37.335938-32h21.335938v-21.332031h-21.335938zm0 0"></path><path d="m432 320h-53.332031c-8.832031 0-16-7.167969-16-16v-53.332031c0-8.832031 7.167969-16 16-16h53.332031c8.832031 0 16 7.167969 16 16v53.332031c0 8.832031-7.167969 16-16 16zm-37.332031-32h21.332031v-21.332031h-21.332031zm0 0"></path><path d="m453.332031 512h-394.664062c-32.363281 0-58.667969-26.304688-58.667969-58.667969v-352c0-32.363281 26.304688-58.664062 58.667969-58.664062h394.664062c32.363281 0 58.667969 26.300781 58.667969 58.664062v352c0 32.363281-26.304688 58.667969-58.667969 58.667969zm-394.664062-437.332031c-14.699219 0-26.667969 11.964843-26.667969 26.664062v352c0 14.699219 11.96875 26.667969 26.667969 26.667969h394.664062c14.699219 0 26.667969-11.96875 26.667969-26.667969v-352c0-14.699219-11.96875-26.664062-26.667969-26.664062zm0 0"></path><path d="m496 202.667969h-480c-8.832031 0-16-7.167969-16-16s7.167969-16 16-16h480c8.832031 0 16 7.167969 16 16s-7.167969 16-16 16zm0 0"></path><path d="m122.667969 128c-8.832031 0-16-7.167969-16-16v-96c0-8.832031 7.167969-16 16-16s16 7.167969 16 16v96c0 8.832031-7.167969 16-16 16zm0 0"></path><path d="m389.332031 128c-8.832031 0-16-7.167969-16-16v-96c0-8.832031 7.167969-16 16-16s16 7.167969 16 16v96c0 8.832031-7.167969 16-16 16zm0 0"></path></svg> */}
                  </div>
                  <div className="ot-icon-box__content">
                    <h6 className="icon-box-title">Calendar</h6>
                  </div>
                </div>
              </div>
              <div className="col-lg-2 col-md-4 col-sm-4 col-6 text-center">
                <div className="ot-icon-box icon-box-h4 p-0">
                  <div className="ot-icon-box__icon">
                    {/* <svg viewBox="0 0 512 512">
                                    <g>
                                        <g>
                                            <path d="M477.44,304c0-0.704-0.32-1.344-0.416-2.016c-0.128-1.088-0.288-2.112-0.64-3.136c-0.352-0.992-0.832-1.856-1.344-2.752    c-0.48-0.864-0.992-1.696-1.632-2.464c-0.672-0.8-1.472-1.408-2.272-2.048c-0.8-0.608-1.568-1.216-2.464-1.664    c-0.96-0.48-1.952-0.768-3.008-1.056c-0.672-0.192-1.248-0.576-1.952-0.672c-0.384-0.064-0.768,0.096-1.152,0.064    c-0.416-0.064-0.736-0.256-1.12-0.256H224V50.56c0-0.384-0.192-0.736-0.224-1.12c-0.032-0.384,0.128-0.736,0.064-1.12    c-0.096-0.704-0.48-1.248-0.672-1.92c-0.288-1.056-0.576-2.08-1.088-3.04c-0.448-0.896-1.024-1.664-1.632-2.432    c-0.672-0.864-1.312-1.632-2.112-2.336c-0.736-0.64-1.504-1.088-2.336-1.568c-0.96-0.576-1.888-1.088-2.944-1.44    c-0.928-0.32-1.92-0.448-2.912-0.576c-0.736-0.128-1.376-0.448-2.144-0.448c-0.384,0-0.736,0.192-1.12,0.224    c-0.384,0.032-0.736-0.128-1.12-0.064C88.448,51.296,0,153.28,0,272c0,132.352,107.648,240,240,240    c118.72,0,220.704-88.448,237.28-205.76c0.064-0.384-0.096-0.736-0.064-1.12C477.248,304.736,477.44,304.384,477.44,304z M240,480    c-114.688,0-208-93.312-208-208c0-96.48,67.776-179.424,160-201.28V304c0,8.832,7.168,16,16,16h233.28    C419.456,412.224,336.512,480,240,480z"></path>
                                        </g>
                                    </g>
                                    <g>
                                        <g>
                                            <path d="M272,0c-4.256,0-8.32,1.696-11.328,4.672S256,11.776,256,16l0.064,224.064c0,4.256,1.696,8.32,4.672,11.328    c2.976,3.008,7.104,4.672,11.328,4.672L496,256c8.832,0,16-7.168,16-16C512,107.648,404.352,0,272,0z M288.064,224.064L288,32.608    C389.984,40.416,471.584,122.048,479.392,224L288.064,224.064z"></path>
                                        </g>
                                    </g>
                                </svg> */}
                  </div>
                  <div className="ot-icon-box__content">
                    <h6 className="icon-box-title">Analytics</h6>
                  </div>
                </div>
              </div>
              <div className="col-lg-2 col-md-4 col-sm-4 col-6 text-center">
                <div className="ot-icon-box icon-box-h4 p-0">
                  ...
                  <div className="ot-icon-box__content">
                    <h6 className="icon-box-title">Comments</h6>
                  </div>
                </div>
              </div>
              <div className="col-lg-2 col-md-4 col-sm-4 col-6 text-center">
                <div className="ot-icon-box icon-box-h4 p-0">
                  <div className="ot-icon-box__icon">
                    {/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="m20.25 10c-.414 0-.75-.336-.75-.75v-6.5c0-.689-.561-1.25-1.25-1.25h-12.5c-.689 0-1.25.561-1.25 1.25v4.5c0 .414-.336.75-.75.75s-.75-.336-.75-.75v-4.5c0-1.517 1.233-2.75 2.75-2.75h12.5c1.517 0 2.75 1.233 2.75 2.75v6.5c0 .414-.336.75-.75.75z"></path><path d="m21.25 24h-18.5c-1.517 0-2.75-1.233-2.75-2.75v-11.5c0-1.517 1.233-2.75 2.75-2.75h4.836c.468 0 .907.182 1.238.513l1.414 1.414c.046.046.11.073.176.073h10.836c1.517 0 2.75 1.233 2.75 2.75v9.5c0 1.517-1.233 2.75-2.75 2.75zm-18.5-15.5c-.689 0-1.25.561-1.25 1.25v11.5c0 .689.561 1.25 1.25 1.25h18.5c.689 0 1.25-.561 1.25-1.25v-9.5c0-.689-.561-1.25-1.25-1.25h-10.836c-.467 0-.907-.182-1.237-.513l-1.414-1.414c-.047-.047-.11-.073-.177-.073z"></path></svg> */}
                  </div>
                  <div className="ot-icon-box__content">
                    <h6 className="icon-box-title">Folders</h6>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="about-h4">
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-xl-5 col-lg-6 align-self-center">
                <div className="ssub-yes">
                  <div className="ot-heading">
                    <span className="ot-heading__sub">TRACKING</span>
                    <h2 className="ot-heading__title">
                ...
                <div className="space-3"></div>
                <p className="lead">
                  See every transaction owner in one place for every type of
                  operational spend.
                </p>
                <p>
                  Enable fastter purchasing and give every employee access to
              ...
              <div className="col-xl-5 offset-xl-2 col-lg-6 mb-5 mb-lg-0 align-self-center order-lg-last order-first">
                <img src="https://via.placeholder.com/470x508.png" alt="" />
              </div>
            </div>
            <div className="space-80"></div>
            <div className="space-60 d-none d-md-block"></div>
            <div className="row">
              <div className="col-xl-5 col-lg-6 mb-5 mb-lg-0 align-self-center">
                <img src="https://via.placeholder.com/470x530.png" alt="" />
              </div>
              <div className="col-xl-5 offset-xl-2 col-lg-6 align-self-center">
                <div className="ssub-yes">
                  <div className="ot-heading">
                    <span className="ot-heading__sub">best success</span>
                    <h2 className="ot-heading__title">
            ...
            <div className="row">
              <div className="col-lg-3 col-md-6 col-sm-6 mb-5 mb-lg-0">
                <div className="space-80 d-none d-lg-block"></div>
                <div
                  className="ot-progress-circle text-center"
                  data-color="#1080d0"
                  data-height="4"
                  data-size="165"
                >
                  <div className="ot-progress-circle__inner" data-percent="76">
                    <span>
                      <span className="percent">76%</span>
                    </span>
                  </div>
                  <h5 className="ot-progress-circle__title">Prosperity</h5>
                  <p className="ot-progress-circle__des">
                    As technology layers deeper and deeper into the fabricof our
                  </p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 col-sm-6 mb-5 mb-lg-0">
                <div
                  ...
                  data-size="165"
                >
                  <div className="ot-progress-circle__inner" data-percent="99">
                    <span>
                      <span className="percent">99%</span>
                    </span>
                  </div>
                  <h5 className="ot-progress-circle__title">Security</h5>
                  <p className="ot-progress-circle__des">
                    As technology layers deeper and deeper into the fabricof our
                  </p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 col-sm-6 mb-5 mb-sm-0">
                <div className="space-80 d-none d-lg-block"></div>
                <div
                  className="ot-progress-circle text-center"
                  data-color="#1080d0"
                  ...
                  data-size="165"
                >
                  <div className="ot-progress-circle__inner" data-percent="70">
                    <span>
                      <span className="percent">70%</span>
                    </span>
                  </div>
                  <h5 className="ot-progress-circle__title">Surety</h5>
                  <p className="ot-progress-circle__des">
                    As technology layers deeper and deeper into the fabricof our
                  </p>
                </div>
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div
                  ...
                  data-size="165"
                >
                  <div className="ot-progress-circle__inner" data-percent="91">
                    <span>
                      <span className="percent">91%</span>
                    </span>
                  </div>
                  <h5 className="ot-progress-circle__title">Assurance</h5>
                  <p className="ot-progress-circle__des">
                    As technology layers deeper and deeper into the fabricof our
                  </p>
                </div>
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2 text-center">
                <div className="ssub-yes">
                  <div className="ot-heading">
                    <span className="ot-heading__sub">What We provide</span>
                    <h2 className="ot-heading__title">
                      Peace of Mind with Scalable Spend
                    </h2>
                  </div>
                </div>
            ...
            <div className="row">
              <div className="col-md-6 mb-4 mb-md-0">
                <div className="ot-position-left">
                  <div className="ot-icon-box service-h4">
                    <div className="ot-icon-box__icon">
                    ...
                    <div className="ot-icon-box__content">
                      ...
                      <div className="space-4"></div>
                      <div className="icon-box-des">
                        As technology layers deeper and deeper into the fabric
                        of our everyday life, its impacts
                      </div>
                    </div>
                  </div>
                  <div className="space-30"></div>
                  <div className="ot-icon-box service-h4">
                    ...
                    <div className="ot-icon-box__content">
                      <h5 className="icon-box-title">Service Acceleration</h5>
                      <div className="space-4"></div>
                      <div className="icon-box-des">
                        As technology layers deeper and deeper into the fabric
                        of our everyday life, its impacts
              ...
              <div className="col-md-6">
                <div className="ot-position-left">
                  <div className="ot-icon-box service-h4">
                    ...
                    <div className="ot-icon-box__content">
                      <h5 className="icon-box-title">In Managed Ad Spend</h5>
                      <div className="space-4"></div>
                      <div className="icon-box-des">
                        As technology layers deeper and deeper into the fabric
                        of our everyday life, its impacts
                  ...
                  <div className="ot-icon-box service-h4">
                    <div className="ot-icon-box__icon">
                      {/* <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.001 512.001" style="enable-background:new 0 0 512.001 512.001;" xml:space="preserve">
                    ...
                    <div className="ot-icon-box__content">
                      <h5 className="icon-box-title">Friendly Support</h5>
                      <div className="space-4"></div>
                      <div className="icon-box-des">
                        As technology layers deeper and deeper into the fabric
                        of our everyday life, its impacts
            ...
            <div className="row">
              <div className="col-lg-12 text-center">
                <a href="#" className="octf-btn octf-btn-third btn-medium">
                  Learn More
                </a>
              </div>
            </div>
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2 text-center">
                <div className="ssub-yes">
                  <div className="ot-heading">
                    <span className="ot-heading__sub">Pricing Plans v1</span>
                    <h2 className="ot-heading__title">
                ...
                <div className="space-5"></div>
                <p>
                  Get control and visibility over spending. Try any plan free
                  for 30 days with no lock-in commitments.
                </p>
                <div className="space-20"></div>
              </div>
            </div>
            <div className="row justify-content-center">
              <div className="col-lg-4 col-md-6 mb-5 mb-lg-0">
                <div className="ot-pricing-table --second-color pricing-border radius-main">
                  <div className="ot-pricing-table__header">
                    <h3 className="ot-pricing-table__title">Digital</h3>
                    <span className="ot-pricing-table__subtitle">
                      The easy, safe way to manage online spending at work
                    </span>
                  </div>
                  <div className="ot-pricing-table__price">
                    <div className="ot-pricing-table__price-main">
                      $15<span className="ot-pricing-table__period">/m</span>
                    </div>
                    <span className="ot-pricing-table__price-extra">
                      $159/year
                    </span>
                  </div>
                  <div className="ot-pricing-table__features-list">
                    <ul>
                      <li>Easy to use app</li>
                      <li>Widget generator</li>
                    </ul>
                  </div>
                  <div className="space-70"></div>
                  <div className="ot-pricing-table__footer">
                    <a
                      href="#"
                      className="octf-btn octf-btn-second --price-link-trial"
                    >
                      Start a Free 30-day Trial
                    </a>
                    <a href="#" className="octf-price-link-detail">
                      Learn More
                    </a>
                  </div>
                </div>
              ...
              <div className="col-lg-4 col-md-6 mb-5 mb-lg-0">
                <div className="ot-pricing-table --main-color feature-main radius-main">
                  <div className="ot-pricing-table__header">
                    <h3 className="ot-pricing-table__title">Suite</h3>
                    <span className="ot-pricing-table__subtitle">
                      The complete spend management solution for all your
                      spending
                    </span>
                  </div>
                  <div className="ot-pricing-table__price">
                    <div className="ot-pricing-table__price-main">
                      $59<span className="ot-pricing-table__period">/m</span>
                    </div>
                    <span className="ot-pricing-table__price-extra">
                      $159/year
                    </span>
                  ...
                  <div className="ot-pricing-table__features-list">
                    <ul>
                      <li>Easy to use app</li>
                      <li>Widget generator</li>
                      <li>Neat dashboard</li>
                      <li>Helpful support</li>
                    </ul>
                  </div>
                  <div className="ot-pricing-table__footer">
                    <a href="#" className="octf-btn --price-link-trial">
                      Start a Free 30-day Trial
                    </a>
                    <a href="#" className="octf-price-link-detail">
                      Learn More
              ...
              <div className="col-lg-4 col-md-6">
                <div className="ot-pricing-table --third-color pricing-border radius-main">
                  <div className="ot-pricing-table__header">
                    <h3 className="ot-pricing-table__title">Medium</h3>
                    <span className="ot-pricing-table__subtitle">
                      The easy, safe way to manage online spending at work
                    </span>
                  </div>
                  <div className="ot-pricing-table__price">
                    <div className="ot-pricing-table__price-main">
                      $25<span className="ot-pricing-table__period">/m</span>
                    </div>
                    <span className="ot-pricing-table__price-extra">
                      $159/year
                    </span>
                  ...
                  <div className="ot-pricing-table__footer">
                    <a
                      href="#"
                      className="octf-btn octf-btn-third --price-link-trial"
                    >
                      Start a Free 30-day Trial
                    </a>
                    <a href="#" className="octf-price-link-detail">
        ...
        <section className="join-h4">
          <div className="container">
            <div className="space-90"></div>
            <div className="row">
              <div className="col-xl-5 align-self-center mb-5 mb-lg-0">
                <div className="ssub-yes">
                  <div className="ot-heading">
                    <span className="ot-heading__sub text-light">
                      join today
                    </span>
                    <h2 className="ot-heading__title text-light">
                      The Best Solution to Manage Your Spending
                    </h2>
                  </div>
                </div>
                <div className="space-10"></div>
                ...
                <p className="text-light">
                  A modern approach to your spending. Intuitive software and
                  cards designed together for the way.
                </p>
                <div className="space-20"></div>
                <a href="#" className="octf-btn octf-btn-main btn-large">
                  Try It Now
              ...
              <div className="col-xl-6 offset-xl-1 text-xl-right align-self-center">
                <div className="join-img-h4">
                  <img src="https://via.placeholder.com/902x713.png" alt="" />
                </div>
              </div>
            </div>
            <div className="space-90"></div>
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-lg-12 text-center">
                <div className="ssub-yes">
                  <div className="ot-heading">
                    <span className="ot-heading__sub">What peeps say</span>
                    <h2 className="ot-heading__title">
              ...
              <div className="col-lg-12">
                <div className="ot-testimonial-slider ot-testimonial-s1 image-position-aside owl-theme owl-carousel">
                  <div className="ot-testimonial-s1__item">
                    <div className="tcontent">
                      <div className="ticon">
                        <i className="ot-flaticon-quote"></i>
                      </div>
                      <h4 className="ttitle">Excelent!!</h4>
                      <div className="tdesc">
                        « I am an advertiser, app developer, service provider or
                        agency looking to reach the right customers and
                        maximize. »
                      </div>
                    </div>
                    <div className="tmeta flex-middle">
                      <img
                  ...
                  <div className="ot-testimonial-s1__item">
                    <div className="tcontent">
                      ...
                      <h4 className="ttitle">Wonderful!!!</h4>
                      <div className="tdesc">
                        « I am an advertiser, app developer, service provider or
                        agency looking to reach the right customers and
                        maximize. »
                  ...
                  <div className="ot-testimonial-s1__item">
                    <div className="tcontent">
                      ...
                      <h4 className="ttitle">Perfectly!!!</h4>
                      <div className="tdesc">
                        « I am an advertiser, app developer, service provider or
                        agency looking to reach the right customers and
                        maximize. »
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="ot-client-logo-slider owl-theme owl-carousel">
                  <a href="client_link">
